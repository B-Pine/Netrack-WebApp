...
SECRET_KEY = 'django-insecure-(n!98@73r2#b4=yclzge1^ii)=^660)-+!512)jo#-$#icp5bm'
...
MEDIA_ROOT = os.path.join(BASE_DIR,'uploads')   #this line is added and it serves as the root address of 
#uploaded file
